...
/**
 * Manejador global de excepciones (@RestControllerAdvice) de ms-ofertas.
...
public class GlobalExceptionHandler {
    ...
    /** Traduce RecursoNoEncontradoException (lanzada por OfertaService) a HTTP 404 (NOT_FOUND). */
    ...
    /** Captura violaciones de restricciones de la base de datos (ej. código de cupón duplicado) y responde HTTP 409 (CONFLICT). */
